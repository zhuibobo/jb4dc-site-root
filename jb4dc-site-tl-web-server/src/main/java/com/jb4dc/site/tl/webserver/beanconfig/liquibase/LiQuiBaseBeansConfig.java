package com.jb4dc.site.tl.webserver.beanconfig.liquibase;
...
public class LiQuiBaseBeansConfig {
    ...
    public Liquibase liquibase(DataSource dataSource) throws JBuild4DCGenerallyException {
        ...
        try {
            ...
            liquibase = new Liquibase("liquibase/jb4dc-site-db-changelog.xml", new ClassLoaderResourceAccessor(), database);
